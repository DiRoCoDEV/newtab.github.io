...
- `redirect.html` — a super-fast redirect page that immediately forwards to `newtab.html`
...
2. If Zen Browser doesn’t allow a direct new-tab HTML page, set Zen Browser’s new tab page to `redirect.html` instead.
3. Keep `zen-browser-dark.svg` next to `newtab.html` so the favicon loads correctly.
